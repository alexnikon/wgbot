...
Downloaded configuration files use the current `server_name` as their filename. Whitespace and punctuation are normalized to hyphens, for example `USA NY` becomes `USA-NY.conf`.
